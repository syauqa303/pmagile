...
if($_GET["action"]=="reject"){
	...
	*/
	...
	if($r = mysql_fetch_array($q)){
		...
		$dayend = mktime(23,59,0,date("m",$r["starttime"]),date("d",$r["starttime"]),date("Y",$r["starttime"]));
...
<table width="100%"  border="0" cellspacing="0" cellpadding="20">
      <tr>
        <td><h1>Time Solve
            ...
            <?
$q = mysql_query("select timefix.*,emp.Name from timefix,emp where emp.id=timefix.userid");
