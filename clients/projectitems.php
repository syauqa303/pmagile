...
<h1>Manage Project Stories/Items</h1>
		...
		$itemList = table_to_array_addedit("itemlist where projectid=$projectID","title");
		$sprints = table_to_array_addedit("sprints where projectid=$projectID","title");
		
		$fieldShow[2] = $fieldEdit[2]["content"] = $sprints;
		$fieldShow[3] = $fieldEdit[3]["content"] = $itemList;
		$fieldShow[10] = $fieldEdit[10]["content"] = array("Not done","Done");
		$fieldEdit[3]["type"]=$fieldEdit[2]["type"]=$fieldEdit[10]["type"]="__SELECT";
